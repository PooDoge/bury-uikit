...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/bury/logo.png" })));
};
...
var Icon$v = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/bury/9.png" })));
};
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React.createElement(InactiveButton, __assign({ forwardedAs: as, size: size, variant: "text", colorKey: variant === variants.PRIMARY ? "primary" : "textSubtle" }, props)));
    }
...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/bury/9.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 44" }, props),
        React.createElement("image", { width: "205", height: "44", href: "/images/bury/LogoTextNewDark.png" })));
};
...
var Icon$16 = function (props) {
    return (React.createElement(Svg, __assign({ xmlns: 'http://www.w3.org/2000/svg', width: '500', height: '500', "data-name": 'Layer 1', version: '1.1', viewBox: '0 0 500 500' }, props),
        React.createElement("defs", null,
            React.createElement("linearGradient", { id: 'Sienna_Gold_Orange', x1: '33.8', x2: '467.6', y1: '407.6', y2: '407.6', "data-name": 'Sienna, Gold, Orange', gradientUnits: 'userSpaceOnUse' },
                React.createElement("stop", { offset: '0', stopColor: '#a87030' }),
                React.createElement("stop", { offset: '0.3', stopColor: '#fab217' }),
                React.createElement("stop", { offset: '0.4', stopColor: '#f9af19' }),
                React.createElement("stop", { offset: '0.6', stopColor: '#f49834' }),
                React.createElement("stop", { offset: '0.7', stopColor: '#f3903f' }),
                React.createElement("stop", { offset: '1', stopColor: '#a84927' }))),
        React.createElement("g", { strokeWidth: '0' },
            React.createElement("path", { fill: '#fbfcfb', d: 'M134.7 180.1c.2 1.9.9 4.1 1.2 6.1C73.2 202.1-20 265.1 36.5 339.9c-16.8 60 48.3 99.9 94.4 116.7 82.7 30.2 211.3 27 286.9-22.5 66.4-43.4 46.9-89.4 47.9-95.1.3-1.8 12.6-13.8 15.9-31.6 8-43.4-28.1-78.1-61.1-97.5-16.8-9.9-34.8-17.4-53.5-22.5.5-2.2.9-4.5 1.2-6.7C421.7 195.6 503.9 244 487 312.9c-4 16.2-13.9 25.8-14.1 27.3-.6 3.7 10.5 34.3-17.6 69.3-53.7 66.7-181 79.7-258.4 69.6-57.7-7.5-164.1-43.3-169.6-115.8-1.1-14.7 2.6-22.5 2.4-23.7 0-.4-3.9-3.7-5.3-6.1-45.1-76 49.3-138.2 110.5-153.4z' }),
            React.createElement("path", { fill: 'url(#Sienna_Gold_Orange)', d: 'M463.6 341.6c-.3.4-.5.8-.8 1.2-1.2 1.9-2.3 3.5-4.1 4.9s-3.9 2.5-5.9 3.6c-1.1.6-2.2 1.2-3.3 1.9-7.7 5-15.5 9.8-23.4 14.4-15.4 8.9-31.4 17-47.7 24-57.2 24.4-119.5 32.2-180.7 22.9-49-7.5-96.5-26.5-136.8-56.4-3.6-2.6-10.9-10.8-14.3-13.9-3.4-3.1-7.4-4.4-10.1-4.2-16.8 60 48.3 99.9 94.4 116.7 82.7 30.2 211.3 27 286.9-22.5 65.7-43 47.3-88.4 47.9-94.9 0 .7-1 1.1-1.4 1.6s-.5.5-.7.8z' }),
            React.createElement("path", { fill: '#38bfbc', d: 'M135.9 186.2c2.9 18.1 11.9 30.8 11.8 32.5 0 .4-4.1 6.7-4.4 7-1.7 1.3-20.1 6.3-38.8 19.4-60.2 42.4-41.2 94.8 17.6 123.4 20.1 9.8 37.8 12 39.4 13.4 1.1 1 3.4 15.2 13.2 27.3-43.4-4.2-92.2-26.7-125.8-55.9-3.2-5.3-9.6-9.7-12.3-13.4C-19.9 265.1 73.2 202 136 186.2z' }),
            React.createElement("path", { fill: 'none', d: 'M464.1 339.9v0zM464 339.7zM464.3 340.2s0 .1.1.2c0 0 0-.1-.1-.2z' }),
            React.createElement("path", { fill: '#38bfbc', d: 'M354.8 220.9v-.2.2zM420.4 209.9c-16.8-9.9-34.8-17.4-53.5-22.5-4 19.3-12.8 29-12.9 30.7 0 .2.3 1.3.7 2.7.2-.6 4.5-2.1 7.9-2.6 4.9-.6 9.6.6 13.5 3.8 4.7 3.9 8.3 9.9 9.6 16v.4c1.6.9 3.3 1.9 5 3 65.7 42.3 52.5 97.9-13.5 128.2-18.6 8.5-35.9 11.1-37.6 12.2-1.5.9-5 17.8-14.4 28.6 40-4.9 96.3-26.8 126.4-54.7l.7-.7 1-1 1.3-1.3c.4-.4 1-1 1.4-1.5s1-1.1 1.5-1.6 1-1.1 1.6-1.6 1-1.1 1.5-1.6.9-1 1.4-1.5.8-.9 1.2-1.3.6-.7 1-1.1.7-.9 1-1.4c.1-.3.2-.5.3-.8 0-.3.2-.6.2-.9 0-.3 0-.6.2-.9s.1-.2.2-.3c.2-.2.3-.5.5-.7s.5-.6.7-.9.6-.7.8-1.1.6-.9 1-1.3.7-1 1.1-1.5.8-1.1 1.2-1.7l1.2-1.8c.4-.6.8-1.3 1.2-2l1.2-2.1c.4-.7.8-1.5 1.2-2.3l1.2-2.4c.4-.8.8-1.7 1.1-2.6s.7-1.8 1-2.7.6-1.9.9-2.9.5-2 .8-3 .3-1.2.4-1.8c8-43.4-28.1-78.1-61.1-97.5z' }),
            React.createElement("path", { fill: '#1aa6b5', d: 'M285.8 417.7c-23.7 1.8-47.5 2-71.1-.6 13.1-9.2 14.8-24.8 16.2-25.5 1.8-.9 37.6-.9 39.4 0 1.3.7 3.6 18.2 15.6 26.1z' }),
            React.createElement("path", { fill: '#333232', d: 'M390.7 241.5c-.9-.5-1.7-1.1-2.5-1.6 0-.2 0-.5-.1-.7-1.9-6.7-5.4-13.5-11.1-17.5-4.8-3.3-11.7-5-17.5-3.8-.6.1-5.2 1.5-4.9 2.5-.4-1.2-.6-2.1-.6-2.3.2-1.7 8.9-11.4 12.9-30.7.5-2.2.9-4.5 1.2-6.7 2.6-19.4 0-39.3-7.1-57.4-1.8-4.5-6.4-10.3-6.5-10.9-.5-3.3 13.5-30.7.6-65.6-19-51.4-61.4 10.4-67.3 11.2-.6 0-8.5-3.1-12.3-3.6-38.8-5.5-54.8 3.8-57.6 3-2.9-.7-32.5-33.9-48.8-31.6-12.9 1.9-21.5 25.3-23.2 36.8-4.5 29.3 4.3 46.2 4.1 48.6 0 .7-5.1 7.3-7.1 12.2-6.7 17.1-9.9 38.4-8.2 56.8.2 1.9.9 4.1 1.2 6.1 2.9 18.1 11.9 30.8 11.8 32.5 0 .4-4.1 6.7-4.4 7-1.7 1.3-20.1 6.3-38.8 19.4-60.2 42.4-41.2 94.8 17.6 123.4 20.1 9.8 37.8 12 39.4 13.4 1.1 1 3.4 15.2 13.2 27.3 10.3 12.8 25.9 17.8 40 7.9 13.1-9.2 14.8-24.8 16.2-25.5 1.8-.9 37.6-.9 39.4 0 1.3.7 3.6 18.2 15.6 26.1 13.3 8.7 29.4 4.2 39.4-7.3 9.4-10.7 12.9-27.6 14.4-28.6 1.7-1 19-3.6 37.6-12.2 66-30.3 79.2-86 13.5-128.2z' }),
            React.createElement("g", null,
                React.createElement("g", { fill: '#1aa6b5' },
                    React.createElement("path", { d: 'M138.5 244.5c3.6-1.9-.5 10.3-.9 19.8-1.8 41.3 9.9 64.1 20.3 101.8-79.6-21.9-107.6-81.5-19.4-121.5zM387.7 257.9c.6.4.7 12.1.7 12.9.2 19.7-5.2 34.2-18.5 49-4.5 5-9.8 9-15.2 13s-1.9 1.2-2.4 2c-.9 1.5-9.2 29-9.1 33.1 73.3-22 100.4-68.9 44.6-110zM234.3 352.1h32.3l.9 25.2-33.2.9v-26.1z' })),
                React.createElement("path", { fill: '#fbfcfb', d: 'M185.3 254.8c-1.3.5 5 5.3 7.9 7.3 28 19.6 55.7 26.4 88.2 13.4 3.4-1.4 26-13 22.6-15.2 15.6-5.9 30.2-15.6 41.2-28.6-.2.4-.6 4.4-1.2 5.8-20.9 47.2-58.3 38.9-66.4 95.7-9.9 3.6-8 9.8-9.1 10.3-1.5.8-33 .6-34.7 0-1.2-.4-4.2-7.8-9.7-9.7-1.4-9.6-6.4-26.3-11.8-34.3-10.6-16-54.3-39.7-56.4-69 9.4 9.4 17.5 18 29.4 24.3z' }),
                React.createElement("path", { fill: '#e7e6e1', d: 'M304 260.3c3.4 2.2-19.3 13.8-22.6 15.2-32.5 13-60.2 6.3-88.2-13.4-2.9-2-9.2-6.8-7.9-7.3 33.8 17.9 83.5 18.9 118.8 5.5z' }),
                React.createElement("path", { fill: '#fbfcfb', d: 'M172.3 387.9c17-3.3 38.8 5.5 51.7-9.7-5.3 42-36.5 50.2-51.7 9.7z' }),
                React.createElement("path", { fill: '#f09e40', d: 'M329.3 386.7c-14.8 0-41.4 4.4-51.7-6.1-2.7-17.4-2.5-29.9 0-47.4 8.1-56.8 45.6-48.5 66.4-95.7.6-1.4 1-5.4 1.2-5.8.7-1.5 3.1-6.1 4.1-4 16.7 63.1 1.5 76.1-11.2 121.5-3.4 12.3-4.5 25.3-8.8 37.4z' }),
                React.createElement("path", { fill: '#fbfcfb', d: 'M329.3 386.7c-13.3 37.4-45 38.1-51.7-6.1 10.3 10.5 36.9 6 51.7 6.1zM194.1 75.6c-1.1-.9-1.6-2.4-2.4-3.6-3.1-5.1-12.3-21.8-19.1-20.1-8.8 8.3-9.9 29.1-7.3 40.7-.1.1.2 1.3 0 1.5-3 3.1-6.2 6.2-9.4 9.1-4.1-17.2-4.5-52.4 9.4-64.7 18.8-6.6 31.5 17.1 40.6 30.7 0 1.2-10.3 5.2-11.8 6.4z' }),
                React.createElement("path", { fill: '#bb3e3c', d: 'M191.7 71.9c-7.2 3.1-20.7 14.9-26.5 20.7-2.6-11.6-1.4-32.4 7.3-40.7 6.8-1.7 16 14.9 19.1 20.1z' }),
                React.createElement("path", { fill: '#fbfcfb', d: 'M339.9 37.3c12.4 10.9 15.9 50.8 8.5 65.6-2.8-3.5-5.9-7.2-9.1-10.3 3.3-26.6-2.6-63.1-25.3-21.3-.8 1.5-1.9 3-2.9 4.3-3.4-2.8-10.9-5.8-11.2-6.4-1-2.6 21.9-38.2 40-31.9z' }),
                React.createElement("path", { fill: '#bb3e3c', d: 'M339.3 92.6c-7.9-7.8-16-15.4-25.3-21.3 22.7-41.8 28.6-5.3 25.3 21.3z' }),
                React.createElement("g", null,
                    React.createElement("path", { fill: '#fbfcfb', d: 'M360.5 163.7c.3 21.8-5.2 41.2-18.2 58.6-48.8 65.2-203.3 51.9-199.9-59.6 0-.3 1.2-1.4 1.2-1.5 8.2-10.2 44.9-5.7 46.4-1.5.5 1.3-1.6 6.3 2.9 13.4 13 20.5 35.1-5.3 52.6-7 27.2-2.7 42.5 22.4 59.4 12.2 8.9-5.4 7.6-16.4 7.9-17.3 2.4-6.7 35.7-10.7 47.6 2.7z' }),
                    React.createElement("path", { fill: '#333232', d: 'M250.8 182.5c25.6-.2 26.4 36.1-4.1 32.2-21.5-2.7-17.6-32.1 4.1-32.2z' }),
                    React.createElement("path", { fill: '#333232', d: 'M212 201.4c4.3-1.7-1.5 12.9 10.6 20.1 14.8 8.8 26.2-2.3 27.6-2.4.8 0 8.3 4.9 12.9 5.5 14.5 1.7 26.4-7.5 25.3-23.1 10.8-1.7 3.6 25.8-17.6 28-12.3 1.3-19-4.3-20-4.3-1.6 0-15.6 9.6-31.2.6-10.5-6.1-13.3-24.5-7.6-24.3z' })),
                React.createElement("path", { fill: '#f09e40', d: 'M155.9 230.5c2.2 29.3 45.8 53 56.4 69 5.4 8.1 10.4 24.7 11.8 34.3 2 13.7 1.7 30.7 0 44.4-13 15.2-34.7 6.4-51.7 9.7-5.7-15.2-7.5-31.4-11.8-47.1-3-11.1-8.4-21.6-11.2-32.8-6.4-26.3-5.9-55 5-79.9 1.8 1.4 1.4 2.3 1.5 2.4z' }),
                React.createElement("g", null,
                    React.createElement("path", { fill: '#f09e40', d: 'M339.9 37.3c-18.1-6.3-41 29.3-40 31.9.2.6 7.7 3.6 11.2 6.4 5 4 30.5 30.5 34.1 35.6 10.7 15.3 15.1 34.1 15.3 52.6-11.9-13.4-45.2-9.5-47.6-2.7-.3.9.9 11.9-7.9 17.3-16.8 10.3-32.1-14.8-59.4-12.2-17.6 1.7-39.6 27.5-52.6 7-4.5-7.1-2.4-12.1-2.9-13.4-1.6-4.1-38.2-8.7-46.4 1.5 0-.2-.9-1.2-.6-4.6 1.6-15.8 6.8-33.1 16.5-45.6 2-2.6 32.7-34 34.7-35.6 1.5-1.1 11.7-5.2 11.8-6.4-9-13.6-21.8-37.3-40.6-30.7 1.3-1.2 2.5-3.2 4.4-3.6 13.3-3 43.6 31.4 46.4 31.6.9 0 7.3-3.6 17-4.9 35.7-4.7 54.7 5.4 57.6 4.9 1.3-.2 10.1-10.6 18.8-17.6 7.6-6.1 21.3-19.4 30.3-11.5z' }),
                    React.createElement("path", { fill: '#fbfcfb', d: 'M291.7 144.9c-3.5.5-8.2 4.2-10 7.3-7.8-3.5-17-18.8-8.5-25.5 11.3-8.9 33.8 4.6 18.5 18.2zM221.7 151.5c-1.9-3.1-6.5-6.7-10-7.3-11.4-11.6.3-23.8 13.8-20.1 14.7 4 6.1 22.8-3.8 27.3z' }),
                    React.createElement("path", { fill: '#333232', d: 'M211.7 144.2c3.5.5 8.1 4.2 10 7.3 14.4 22.8-22.2 37.3-29.4 15.5-4.2-12.9 6.8-24.7 19.4-22.8z' }),
                    React.createElement("path", { fill: '#fbfcfb', d: 'M208.5 155.8h3.5c8 9.6-11.1 10.4-3.5 0z' }),
                    React.createElement("g", null,
                        React.createElement("path", { fill: '#333232', d: 'M281.7 152.1c1.8-3.1 6.5-6.8 10-7.3 19-2.9 25.7 21 13.2 29.8-14.3 10-33.5-5.3-23.2-22.5z' }),
                        React.createElement("path", { fill: '#fbfcfb', d: 'M291.4 155.2c11.5 3.9-3 14.5-3.2 2.7l3.2-2.7z' }))),
                React.createElement("g", null,
                    React.createElement("path", { fill: '#f09e40', d: 'M380.9 244.8c-.3.3-.7.5-1.2.6-5.5 1.8-11.2 1.9-16.7.2-.3 0-.6-.2-.9-.4-.3 0-.7-.2-1-.3.5 2.4.9 4.8 1.3 7.2.3 1.7.6 3.3.9 5 .3 1.8.3 3.5.5 5.3.7 7 .9 14 .3 20.9-.5 6.1-1.6 12.1-3.1 18-.6 2.5-1.3 5-2.1 7.5-.4 1.3-.8 2.5-1.2 3.8-.2.7-.4 1.3-.6 2-.1.4-.3 1.7-.6 1.9 11.9-9.4 19.5-20.4 22.9-35.5 2.1-9.5 3-19.4 2.2-29.2-.2-2.4-.5-4.8-.9-7.1z' }),
                    React.createElement("path", { fill: '#fff', d: 'M362.9 245.6c5.6 1.6 11.2 1.6 16.7-.2.5-.1.9-.4 1.2-.6-.5-2.8-1.1-5.5-1.8-8.2-1.5-5.3-4.4-9.8-9.9-11.4-2.9-.9-6.2-.5-8.7 1.3-1.1.8-2.3 1.9-3 3.3-.3.5.6 1.6.7 2.1.3 1 .5 2.1.8 3.1.5 2.1 1 4.3 1.5 6.5.2 1.2.5 2.3.7 3.5.3.1.6.2 1 .3.3.1.6.3.9.4z' }))))));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Bury Farms home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "Bury Farms home page" }, innerLogo))));
};
...
var Invisible = styled.div(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  opacity: 0;\n  min-height: 24px;\n  min-width: 80px;\n"], ["\n  opacity: 0;\n  min-height: 24px;\n  min-width: 80px;\n"])));
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, null,
            cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
                ...
                React.createElement(Text, { color: "textSubtle", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Invisible, null,
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React.createElement(Flex, { mb: "32px", justifyContent: "center" },
            React.createElement(LinkExternal, { small: true, href: "https://shibariumscan.io/address/" + account, mr: "16px" }, "View on ShibariumScan"),
...
var useNetworkModal = function (chain) {
    var onPresentNetworkModal = useModal(React.createElement(NetworkModal, { chain: chain || "Wrong Network" }))[0];
...
var Avatar = function (_a) {
    ...
    return (React.createElement(StyledAvatar, { title: username, onClick: function () {
